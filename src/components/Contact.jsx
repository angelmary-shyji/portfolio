          ...
          <div className="contact-grid">
            <motion.div variants={item} className="contact-info">
              ...
              <div className="contact-socials">
                <a href="https://github.com/angelmary-shyji" target="_blank" rel="noreferrer" className="social-btn">
                ...
                <a href="https://www.linkedin.com/in/angelmaryshyji-/" target="_blank" rel="noreferrer" className="social-btn">
